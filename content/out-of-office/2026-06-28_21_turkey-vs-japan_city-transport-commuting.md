...
countries: Turkey, Japan
subject: City transport & commuting culture
word_count: ~1200
images:
  hero: https://images.pexels.com/photos/2078950/pexels-photo-2078950.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/1557659/pexels-photo-1557659.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Istanbul Metropolitan Municipality Transport Masterplan 2023
    - Tokyo Metro Annual Report 2024
    - UITP Global Public Transport Data Report 2024
    - Japan Ministry of Land, Infrastructure, Transport and Tourism — Punctuality Statistics
  forums:
    - Reddit r/istanbul — "Buses are suggestions, not timetables"
    - Internations Tokyo — expats on rush-hour etiquette and white-glove train pushers
    - Quora — "What is it like commuting in Istanbul vs Tokyo?"
    - expat.com Istanbul — surviving the minibus system as a foreigner
---
...
![Hero image](https://images.pexels.com/photos/2078950/pexels-photo-2078950.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|-------|---------|
| Carry exact change or an Istanbulkart for buses and metro | Expect the driver to wait if you're ten seconds behind |
| Shout your destination at the dolmuş driver before boarding | Stand in the road waving — you'll be ignored and possibly mowed down |
| Accept that your journey time estimate is a range, not a fact | Book the dolmuş seat near the door if you get motion sick |
| Download BiTaksi or Uber — taxis can be creative with routes | Assume every taxi meter is running honestly |

## Japan — Do's & Don'ts

| ✅ Do | ❌ Don't |
|-------|---------|
| Queue behind the painted lines on the platform — in order | Talk loudly on your phone in any rail carriage, ever |
| Bow slightly or nod when someone lets you off the train first | Block the left side of the escalator (walk left, stand right — or vice versa, city-dependent) |
| Use an IC card (Suica or Pasmo) — cash on buses is slow and shameful | Eat or drink on commuter trains; even water bottles attract side-eye |
| Study the route map in advance; transfers can be complex | Attempt to board a rush-hour Tokyo Metro train without committing fully |
...
![Body image](https://images.pexels.com/photos/1557659/pexels-photo-1557659.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
