...
countries: Poland, UAE
subject: Public behaviour norms (queues, noise, personal space)
word_count: ~1200
images:
  hero: https://images.pexels.com/photos/1587014/pexels-photo-1587014.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/2422265/pexels-photo-2422265.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Polish Central Statistical Office — Urban Social Behaviour Survey 2023
    - UAE Government Portal — Public Conduct Guidelines and Community Standards 2024
    - World Values Survey — Poland and UAE Social Norms Data 2023
    - Dubai Statistics Centre — Public Space Usage Report 2024
  forums:
    - Reddit r/poland — "What surprises foreigners most about Polish public behaviour?"
    - Internations Dubai — expats on navigating UAE public conduct rules
    - Quora — "Is it true Poles don't smile at strangers? Asking as someone who just moved here"
    - expat.com UAE — understanding what's actually enforceable vs. what's custom
---

# The Art of Being in Public When Public Has Very Different Rules

🇵🇱 Poland vs 🇦🇪 UAE | *By Suki Nakamura, Out of Office*

Public space is where a culture's actual values live — not in its tourism slogans or its national anthems, but in how its citizens behave when they're waiting for a bus, or sharing a pavement, or eating a sandwich in a park. Every culture has rules for this. Some of them are written down. Most of them aren't, which is what makes moving countries such an educational experience for anyone who believed their original country's rules were simply correct human behaviour rather than a specific social agreement negotiated over centuries.
...
![Hero image](https://images.pexels.com/photos/1587014/pexels-photo-1587014.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|-------|---------|
| Give up your seat on public transport without being asked — it is expected | Greet strangers with a beaming smile; you will alarm them |
...
| Greet shop staff when entering — *dzień dobry* is not optional | Mistake directness for rudeness; Polish communication is simply honest |
| Be punctual; arriving late is not charming here — it is inconsiderate | Expect emotional displays from strangers in public; this is not that culture |

## UAE — Do's & Don'ts

| ✅ Do | ❌ Don't |
|-------|---------|
| Dress modestly in malls, souks, and public spaces — especially shoulders and knees | Display affection publicly beyond handholding; fines exist and are enforced |
...
| Accept that the local Emirati population has different norms from expat communities | Photograph strangers without permission — this is seriously frowned upon |

## Poland: Serious Business, Seriously Observed
...
The smile is the first thing. In Poland, smiling at strangers — the reflexive, performative smile of the English or the American — is not a social lubricant. It is, if anything, suspicious. You smile at people you know. You smile because something is funny. You do not smile at the person standing next to you at the pedestrian crossing because you are standing next to someone and this is an opportunity to project warmth. This is not warmth — this is performance, and Poles, who are excellent at distinguishing between the two, find it slightly unnerving.

Once you understand this, you start to read Polish public behaviour correctly. The directness, which foreigners often experience as bluntness, is actually a form of respect. You are being told the true thing rather than the comfortable thing. The lack of small talk is not hostility — it's a preference for silence over noise that doesn't carry meaning. The person who doesn't chat on the tram is not unfriendly; they are simply not chatting, which is a perfectly valid condition for a human being to be in.

Queue culture in Poland is genuine and seriously maintained. Cutting in line is not a minor transgression; it is a character revelation. The correct behaviour is to find the end of the queue, join it, and wait, and no amount of urgency on your part changes this calculus. Sunday noise regulations — quiet hours during which power tools, loud music, and general domestic chaos are to be minimised — are observed with a seriousness that reflects a genuine social contract about shared space. Poles take their neighbours seriously, which means both caring about them and not disturbing them.

## UAE: Formal Codes, Enforced

The UAE is not merely a country with conservative social norms — it is a country where some of those norms are encoded in law, and where the distance between custom and legislation is shorter than many expats initially appreciate. This is not a criticism. It is information that the approximately 88% of the UAE's population who are non-Emirati absolutely need to have clearly in their heads on arrival.

The dress code in public spaces is perhaps the most immediately relevant. "Modest dress" in UAE public space means covered shoulders and knees at minimum, and in more conservative contexts — older souks, mosques, some government buildings — considerably more coverage than that. Dubai's malls, which operate as primary social infrastructure in a city with almost no traditional public square, post dress code notices at entrances. These are not suggestions. They are also not aggressively enforced in most modern malls — but the fact that they exist is the point.
...
![Body image](https://images.pexels.com/photos/2422265/pexels-photo-2422265.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
