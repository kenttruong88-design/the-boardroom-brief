...
sources:
  official:
    ...
    - National Institute of Korean Language — Korean Proficiency Standards 2023
    - European Commission — Language Skills and Integration Survey 2024
    - Korean Ministry of Culture — Foreign Language Support in Urban Areas 2024
  forums:
    - Reddit r/italianlearning — "Honest assessment: how necessary is Italian for daily life?"
    - Internations Seoul — expats on learning Korean and what breaks first
    - Quora — "Can you live in Italy long-term speaking only English?"
    - expat.com South Korea — surviving the bureaucracy without Korean
---

# Every Foreigner Is Either Charmed or Humbled — Usually Both

🇮🇹 Italy vs 🇰🇷 South Korea | *By Suki Nakamura, Out of Africa*
...
In Italy, they respond with theatrical exasperation, a rapid-fire attempt to help you in Italian regardless, and then — if they like you, which they usually do — a great deal of warmth and probably an unsolicited recommendation for their cousin's restaurant. In South Korea, they respond with polite, slightly pained efficiency, a translation app produced with the speed of someone who has done this before, and a level of service that remains impeccable despite the mutual incomprehension. These are both perfectly viable responses to a foreigner floundering. They produce completely different emotional experiences.

![Hero image](https://images.pexels.com/photos/2609462/pexels-photo-2609462.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|-------|---------|
| Learn basic Italian — even a little transforms how people treat you | Expect widespread English in smaller towns; Milan and Rome are exceptions, not rules |
| Use gesture confidently — it is a legitimate communication channel here | Apologise excessively for your Italian; just speak it and they'll help |
...
## South Korea — Do's & Don'ts

| ✅ Do | ❌ Don't |
|-------|---------|
| Download Papago (Korean AI translation) — it is your most essential daily tool | Assume the Korean alphabet (Hangul) is too hard; it takes two days to learn to read |
| Learn food vocabulary first — ordering correctly makes daily life immediately better | Expect all younger Koreans to speak English; proficiency varies more than stereotypes suggest |
...
This is, once you accept it, a gift. It forces engagement. You learn the language because you must, and Italy turns out to be exactly the right place to learn it — surrounded by people who treat your attempts with something between amusement and delight, where every mispronunciation is an opportunity for connection rather than judgement. The Italian language barrier is more porous than it initially appears, and the key to getting through it is confidence, gesture, and a willingness to be wrong loudly.

## South Korea: Hangul in Two Days, Everything Else in Two Years

South Korea presents the language barrier in a more structured way than Italy — which is to say, you can learn to read and write Korean (Hangul) in approximately forty-eight hours of genuine effort, which gets you farther than you'd expect and simultaneously makes you realise how little that helps with actually understanding what you're reading.
...
What makes this manageable in South Korea is the infrastructure of accommodation. Translation apps here are culturally normalised to a degree that hasn't quite arrived in Europe. Koreans, particularly in service contexts, produce a translation tool as a routine gesture rather than a last resort. QR codes on restaurant tables link to menus in multiple languages. Subway announcements are in Korean, English, Japanese, and Chinese. The Korean service ethic — which runs deep and is genuinely extraordinary — means that your language barrier will be treated not as your problem but as a shared problem to be efficiently solved.

What makes it isolating is that social fluency is different from functional fluency, and Korean social life has a complexity — the sunbae/hoobae (senior/junior) relationship structure, the group dining and drinking culture, the office hierarchy that bleeds into social settings — that requires language competence to navigate properly. You can exist in South Korea without Korean. You cannot fully belong without it.
...
South Korea's language barrier is structural, patient, and practically supported — but ultimately harder to fully dissolve. The country is extraordinarily good at accommodating non-Korean speakers at the functional level. The social level takes considerably longer.
...
![Body image](https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
