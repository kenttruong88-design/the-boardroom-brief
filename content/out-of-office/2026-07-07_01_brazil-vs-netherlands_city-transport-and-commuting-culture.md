...
sources:
  official:
    - São Paulo Metrô — ridership statistics and network expansion reports
    - SPTrans — São Paulo bus corridor and fare integration data
    - CBS Netherlands — national travel behaviour and cycling statistics
    - Dutch Ministry of Infrastructure — bicycle infrastructure investment reports
  forums:
    - Reddit r/saopaulo — Linha Vermelha rush hour survival threads
    - Reddit r/Netherlands — "I got shouted at in the bike lane" confessionals
    - Internations Amsterdam — expat threads on OV-chipkaart confusion and bike theft
    - Quora — "Is it safe to commute by bus in Rio de Janeiro?"
---

# One Country Commutes on Two Wheels, the Other on a Prayer

🇧🇷 Brazil vs 🇳🇱 Netherlands — *By Suki Nakamura, Out of Office*

São Paulo has a helicopter commuter class. Let that settle for a moment. The traffic in South America's largest city is so comprehensively, operatically terrible that the wealthy simply removed themselves from the ground plane entirely, and the city now hosts one of the largest urban helicopter fleets on Earth. Down below, twenty million people negotiate a daily arrangement of buses, metro lines, motorbike couriers threading lanes at speeds that suggest a personal quarrel with mortality, and traffic jams that are measured — officially, by the traffic authority — in cumulative kilometres. On bad Fridays the queue exceeds 300 kilometres. That is not a commute. That is a geological feature.

The Netherlands, meanwhile, solved commuting decades ago and has spent the time since being insufferable about it. The Dutch own more bicycles than there are Dutch people. Children cycle to school in packs like small, waterproofed wolves. Grandmothers overtake tourists on e-bikes with the serenity of people who have never once worried about parking. It is efficient, it is green, it is admirable, and if you step into a bike lane in Amsterdam you will learn — via bell, then via vocabulary — that Dutch tolerance has precise geographic boundaries, painted in red asphalt.
...
| ✅ Do | ❌ Don't |
|------|---------|
| Get a Bilhete Único in São Paulo; integrated fares are the one mercy the system offers | Flash your phone by an open bus window; it will begin a new life without you |
...
| Use the women-only metro carriages in Rio during rush hour if eligible | Attempt to drive yourself in São Paulo before you understand the motoboys |
| Learn the express bus corridors — they are genuinely fast | Assume an app's arrival time is a promise rather than a mood |
