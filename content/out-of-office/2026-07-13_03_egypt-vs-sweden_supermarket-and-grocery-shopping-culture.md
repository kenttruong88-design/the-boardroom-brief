...
sources:
  official:
    - Egypt Ministry of Supply and Internal Trade — market regulation and produce pricing oversight
    - Sweden Swedish Food Agency (Livsmedelsverket) — retail food standards and labelling requirements
    - Cairo Governorate — local market and souk licensing information
    - Swedish Trade Federation — supermarket chain market share and consumer trends
  forums:
    - Reddit r/Cairo — expats learning the unwritten rules of haggling at local markets
    - Internations Stockholm — members on the culture shock of Sweden's hushed, efficient supermarkets
    - Quora — "Is haggling expected at Egyptian markets, or only for certain items?"
    - expat.com Sweden — thread comparing ICA and Coop shopping habits to home
---

# 🇪🇬 Egypt vs 🇸🇪 Sweden: One Country Wants to Negotiate the Price of Tomatoes, the Other Wants You to Silently Scan Them and Leave
...
| ✅ Do | ❌ Don't |
|---|---|
| Expect to haggle at open-air souks and street markets — it's the norm, not an imposition | Haggle inside fixed-price supermarkets; that etiquette doesn't transfer there |
| Build a relationship with a regular vendor — loyalty gets you better produce and better prices | Handle fruit aggressively; let the vendor select for you, especially early in the relationship |
...
| ✅ Do | ❌ Don't |
|---|---|
| Bag your own groceries quickly at checkout — a queue builds fast if you're slow | Expect small talk with cashiers; efficient silence is the cultural default, not rudeness |
| Bring your own reusable bags — plastic bags cost extra and buying them is mildly frowned upon | Block the aisle browsing indecisively; Swedes shop with clear intent and expect the same |
...
## Egypt: Shopping as Relationship
...
> *Reddit r/Cairo — paraphrased: I paid full asking price at my first souk visit and the vendor looked almost disappointed in me, like I'd skipped a step he was looking forward to.*

> *Internations Stockholm — paraphrased: I said "how are you" to a cashier out of habit and got a genuinely confused look back. Took me months to stop taking the silence personally.*

> *expat.com Sweden — paraphrased: forgot my own bags once and the ninety seconds of visible judgment while I bought a plastic one taught me more about Swedish culture than a year of reading about it would have.*
