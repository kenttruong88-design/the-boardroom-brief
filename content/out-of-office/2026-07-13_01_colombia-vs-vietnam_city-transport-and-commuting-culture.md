...
sources:
  official:
    - TransMilenio S.A. — Bogotá bus rapid transit system operations and ridership data
    - Hanoi People's Committee — urban transport master plan and motorbike registration statistics
    - Bogotá Secretaría de Movilidad — cycling infrastructure and Ciclovía programme
    - Asian Development Bank — Vietnam urban transport and motorbike dependency reports
  forums:
    - Reddit r/Bogota — expats debating TransMilenio rush hour survival tactics
    - Internations Hanoi — members on learning to cross the street without dying
    - Quora — "How do Hanoi residents cross a street with thousands of motorbikes and no traffic lights?"
    - expat.com Colombia — thread comparing Bogotá's bus system to home
---
...
| ✅ Do | ❌ Don't |
|---|---|
| Get a TransMilenio smart card and top it up before rush hour, not during it | Expect a seat, personal space, or mercy between 6–8am and 5–7pm |
| Learn the difference between express and local routes — it saves real time | Assume every red bus goes where the map suggests; route changes happen without notice |
| Try a bicitaxi or the Sunday Ciclovía for a gentler view of the city | Flash a phone or wallet carelessly near packed doors; petty theft targets distracted riders |
| Walk or cycle where possible — Bogotá's bike lane network is genuinely excellent | Rely on punctuality; delays are the rule, not the exception |

**🇻🇳 Vietnam**

| ✅ Do | ❌ Don't |
|---|---|
| Cross the street at a slow, steady, predictable pace — motorbikes flow around you | Stop suddenly or run mid-crossing; that's when collisions actually happen |
| Book a Grab (the local ride-hailing app) for motorbike taxis — it's fast and cheap | Expect lane discipline, indicators, or one-way signs to mean much in practice |
| Wear a helmet even for a short motorbike-taxi hop; it's the law and common sense | Assume rush hour has a start or end time; Hanoi traffic is a permanent weather system |
| Watch locals before attempting any crossing yourself — they've done the maths already | Try to out-walk or dodge bikes; erratic movement is far more dangerous than steady pace |
...
## Vietnam: Traffic as a Living Organism
