...
countries: Singapore, Spain
subject: Public behaviour norms
word_count: ~1200
images:
  hero: https://images.pexels.com/photos/1842332/pexels-photo-1842332.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/1388030/pexels-photo-1388030.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Singapore Statutes — Environmental Public Health Act and MRT by-laws
    - Singapore National Environment Agency — littering and chewing gum enforcement data
    - Spanish municipal ordinances — Madrid and Barcelona noise and terrace regulations
    - Ayuntamiento de Madrid — noise complaint statistics and quiet hours rules
  forums:
    - Reddit r/singapore — chope culture debates and MRT etiquette threads
    - Reddit r/spain — noise complaint threads and terrace culture defence
    - Internations Singapore — expat threads on fines and social rules
    - Quora — "Is Singapore really as strict as people say?"
---

# One Country Fines You for Chewing Gum; the Other Considers Noise a Human Right

🇸🇬 Singapore vs 🇪🇸 Spain — *By Suki Nakamura, Out of Office*

Singapore's public order is the stuff of legend and pub quizzes: chewing gum sales banned since 1992, a S$1,000 fine for eating on the MRT, jaywalking actually enforced, and litter so rare that dropping a receipt feels like performance art. The city works with a smoothness that borders on the eerie. Queues form unprompted. Escalators flow. Reserved seats sit empty in packed carriages because they are reserved, and rules here are not suggestions with legal decoration — they are the operating system.

Spain, meanwhile, is officially one of the loudest countries on Earth and views this as a lifestyle rather than a problem. Dinner at eleven, conversation at rugby-crowd volume, children in restaurants at midnight, an entire street of terraces roaring under someone's bedroom window on a Tuesday — and the person in the bedroom isn't calling the police, because next Tuesday it will be their turn on the terrace. Spanish public space runs on a single principle: the street belongs to everyone, at full volume, indefinitely. One country regulated its way to serenity. The other shouted its way to community. Both are convinced the other has it wrong.

![Hero image](https://images.pexels.com/photos/1842332/pexels-photo-1842332.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|------|---------|
| Respect the tissue packet on the hawker table; the seat is chope'd and that is binding law of the people | Eat or drink on the MRT — yes, including water, yes, they mean it |
...
| Embrace the paseo — the evening stroll is a civic institution | Expect personal space in a queue; Spanish queues are more of a warm cloud |

## Singapore: Order as a Public Utility

The fines are the famous part, and the fines are real: littering from S$300, eating on trains up to S$500, first-conviction vandalism penalties that made global headlines decades ago and still do. The chewing gum ban — enacted after vandals gummed up MRT door sensors — remains the single most efficient piece of national branding ever accidentally produced. Visitors arrive expecting a police state and find something stranger: a city where the rules have been so thoroughly internalised that enforcement is mostly unnecessary.

Because here is what the fine-counting misses. Singapore's public behaviour runs less on fear than on a dense social codebook the state merely formalised. The queue is self-policing. The "chope" — reserving a hawker table by placing a tissue packet on it — is an entirely informal institution with no legal standing and near-universal compliance, which tells you everything: this is a society that will invent its own rules even where the government forgot to supply any. Kiasu culture — the fear of losing out — powers both the queueing discipline and its occasional dark side, the buffet stampede.
