...
word_count: ~1200
images:
  hero: https://images.pexels.com/photos/3243027/pexels-photo-3243027.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/2166553/pexels-photo-2166553.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Instituto Cervantes — Spanish speaker statistics and DELE exam data
    - EF English Proficiency Index — Spain and Vietnam rankings
    - Vietnam Ministry of Education — English education policy reports
    - Real Academia Española — regional variation and usage guidance
  forums:
    - Reddit r/Spain — "Nobody switches to English here" expat threads
    - Reddit r/VietNam — tonal disaster stories and pho-ordering trauma
    - Internations Madrid — threads on surviving bureaucracy in Spanish
    - Quora — "Why is Vietnamese so hard for English speakers to pronounce?"
---
...
![Hero image](https://images.pexels.com/photos/3243027/pexels-photo-3243027.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|------|---------|
| Learn Spanish properly; it's the second-most-spoken native language on Earth and worth every hour | Expect the funcionario at the immigration office to speak English; bring a translator or a prayer |
| Open every interaction with a greeting; transactions without "buenos días" mark you as a barbarian | Assume Spain speaks one language; Catalonia, Galicia and the Basque Country would like a word |
| Embrace the speed; Spaniards speak like the sentence is escaping | Confuse "estar embarazada" with being embarrassed; you've just announced a pregnancy |
| Use your hands, your face, your whole body; paralinguistics count | Practise your Spanish on a Barcelona local who greeted you in Catalan; read the room |

**Vietnam 🇻🇳**

| ✅ Do | ❌ Don't |
|------|---------|
| Learn the tones from day one with audio, not from the page | Trust the Latin script; it is a friendly face on a very hard exam |
| Use the correct pronoun for age and status — anh, chị, em matter enormously | Call an older man "em" unless you enjoy restructuring a relationship in one syllable |
| Let locals laugh with you at your tonal disasters; it's affection, not mockery | Get defensive about being corrected; correction is a gift here |
| Use Google Translate's camera for menus in the provinces | Assume young urban Vietnamese can't speak English; Hanoi's students may floor you |
...
![Body image](https://images.pexels.com/photos/2166553/pexels-photo-2166553.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
