...
word_count: 1210
images:
  hero: https://images.pexels.com/photos/30240904/pexels-photo-30240904.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/1021374/pexels-photo-1021374.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Korean Journal of Business Ethics — hoesik as organisational socialisation tool
    - behalfkr.com — Korea working culture shifts 2024, MZ generation impact
    - Hofstede Insights — South Korea vs UK cultural dimensions (Power Distance, Collectivism)
    - londonlovesbusiness.com — London post-5pm drinking culture analysis
    - bmmagazine.co.uk — British bosses rethinking pub socials
  forums:
    - Quora — working at Samsung HQ as non-Korean expat
    - r/korea — hoesik and foreigners
    - expatarrivals.com — pros and cons of moving to South Korea
    - c-korea.vn — Korean hoesik culture explained
    - juggle.jobs — alcohol-based socialising at work UK
---

# One Country Gets You Drunk to Bond. The Other Gets You Drunk to Relax. The Outcome Is Different.

🇰🇷 **South Korea** · 🇬🇧 **UK**

***By Priya Mehta, The Global Office***

South Korea's hoesik — the mandatory after-work dinner and drinking session — is one of the most institutionalised social bonding rituals in the professional world. Attendance is not exactly compulsory, in the same way that your heartbeat is not exactly compulsory: technically optional, in practice non-negotiable. The UK, meanwhile, has its own after-work drinking culture, organised around the pub, that is merely expected rather than mandatory, which is a distinction that sounds more meaningful than it is when you are on your fourth pint with your line manager on a Thursday. Both countries have made alcohol central to workplace bonding. The routes in — and the routes out — are notably different.

![South Korea vs UK — Bonding culture](https://images.pexels.com/photos/30240904/pexels-photo-30240904.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
...
| ✅ Do | ❌ Don't |
|---|---|
| Attend hoesik events, at least in your first months — skipping is noticed and interpreted as rejection of the group, not as personal scheduling | Refuse drinks from your manager without an explanation; alcohol is offered as a social signal of trust, and refusal reads as social rejection unless a clear reason is given |
| Pour drinks for others before pouring your own — this is not optional etiquette but the primary gesture of hoesik participation | Fill your own glass; wait for a colleague to pour for you and reciprocate the gesture |
| Accept the norebang (karaoke) portion of hoesik as a legitimate team activity — participation, however reluctant, is valued | Leave before norebang if the team is clearly expecting to go; early exits after the first restaurant round are generally acceptable, but abandoning the group mid-hoesik is noted |
| Understand that hoesik is changing — younger Korean colleagues (MZ generation) are increasingly resistant to after-work obligations; reading the room matters | Assume the old rules apply universally; companies with younger or international teams may have significantly more relaxed expectations |
| Build relationships through small daily interactions — shared lunches, coffee breaks, informal conversation — these matter as much as the formal bonding events | Treat bonding as only an after-hours function; Korean workplace relationships are built throughout the day in micro-interactions that foreigners often overlook |

#### 🇬🇧 UK

| ✅ Do | ❌ Don't |
|---|---|
| Accept after-work pub invitations — this is the primary bonding venue in British professional culture, and regular refusals are read as mild social withdrawal | Feel obliged to drink heavily; the British pub culture is actually more tolerant of non-drinkers than its reputation suggests, especially in the current cultural moment |
| Engage in British small talk with patience — weather, sport, mild self-deprecation — this is not avoidance of substance, it is the substance | Push for directness or emotional depth before the social relationship has established itself; British social trust builds slowly and through indirectness |
| Understand that a round system exists and is a social contract — when your turn comes, buy drinks for the group | Leave before your round without explanation; this is a minor social transgression that will be noticed and mildly discussed after your departure |
...
![Bonding culture contrast — South Korea and UK](https://images.pexels.com/photos/1021374/pexels-photo-1021374.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Illustration: The Alignment Times / The Global Office*
...
If you are moving from the UK to South Korea, accept that the social bonding system is more ritualised and more mandatory than you are used to, and participate early — the investment pays off in relationships that are, once established, genuinely warm and loyal. If you are moving from South Korea to the UK, accept that the voluntarism is real but the expectation is real too, and that British colleagues who have never pressured you to come to the pub have nonetheless noticed, gently, that you never do.
