...
word_count: 1010
images:
  hero: https://images.pexels.com/photos/27064826/pexels-photo-27064826/free-photo-of-people-sitting-on-the-beach-near-a-mountain-town.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/9186022/pexels-photo-9186022.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Destatis (German Federal Statistical Office) — Vacation Entitlement Data
    - Germany Federal Holidays Act — 20 days minimum annual leave
    - OECD Working Hours Data — South Korea 1865 hours 2024
    - South Korea Labor Standards Act — annual leave provisions
    - Expedia Vacation Deprivation Report 2016 and 2023
    - Links International — Annual Leave Policies in South Korea
  forums:
    - r/korea
    - r/germany
    - r/expats
...
![Germany vs South Korea — Vacation, PTO, and leave culture](https://images.pexels.com/photos/27064826/pexels-photo-27064826/free-photo-of-people-sitting-on-the-beach-near-a-mountain-town.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|---|---|
| Plan your *Sommerurlaub* well in advance — blocks of 2–4 weeks are the norm | Skip your leave. Managers read unused days as poor planning, not dedication |
| Set a proper out-of-office with instructions not to forward emails | Check work email or Slack during Urlaub. Your team expects radio silence |
| Notify your employer in writing of remaining leave before year-end | Assume unused days roll over automatically — they expire unless employer notified you |
| Coordinate with colleagues and provide covering arrangements | Spring a 3-week absence on your team with no notice |
| Use your full entitlement — it is a legal right, not a favour | Accept payment in lieu of leave. German law forbids it unless employment ends |

#### 🇰🇷 South Korea
| ✅ Do | ❌ Don't |
|---|---|
| Request leave in writing using your company's official system | Assume your 15 legal days are yours to take freely — culture creates friction |
| Take single days or half-days (반차) if a full week feels professionally risky | Stay at your desk if you're genuinely unwell — paid sick leave is not guaranteed by law |
| Time your leave after your manager takes theirs — hierarchy matters | Request extended leave before your one-year anniversary of employment |
| Accept that financial compensation for unused days is common and sometimes preferred | Expect the *hweshik* dinner invitation to be optional |
| Push back gently if you're newer to the workforce — generational change is real | Assume that because the law gives you 15 days, your workplace culture will too |

---

## Germany

German vacation law — governed principally by the Bundesurlaubsgesetz, the Federal Leave Act — operates on the premise that the right to rest is not a workplace benefit but a legal entitlement that cannot be contracted away or socially pressured out of existence. The statutory minimum is 20 days per year for a standard five-day week; in practice, collective bargaining agreements push the average to 28 days, with sectors including energy, finance, and public administration averaging 30 (Destatis, 2024).
...
The cultural attitude reinforces the legal structure. German managers do not look favourably on workers who decline to take their leave; doing so suggests either poor planning or an implied criticism of those who take theirs. The separation between work time and rest time is a feature of German industrial culture that predates the welfare state and has survived multiple economic transformations. Leave in Germany is also taken in extended blocks. The *Sommerurlaub* — the summer holiday — of two to four weeks is not an anachronism but a contemporary norm, with out-of-office messages sometimes set with the explicit instruction not to forward messages, and a promise to catch up upon return. This last practice has generated considerable international commentary, mostly from people who could not quite believe it was real. It is real.
...
![Woman packing a suitcase for vacation](https://images.pexels.com/photos/9186022/pexels-photo-9186022.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
The question of which is easier to change — laws or culture — has a reasonably clear historical answer, and it does not favour the country that is currently paying its workers to go on holiday and finding that they mostly don't. Perhaps the more useful question is whether the workers themselves want it to change — and in South Korea, increasingly, the younger ones do. They have simply not yet figured out how to want it loudly enough for their bosses to hear.
