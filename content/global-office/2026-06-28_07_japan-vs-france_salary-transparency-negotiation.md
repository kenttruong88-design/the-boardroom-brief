...
word_count: 1220
images:
  hero: https://images.pexels.com/photos/6949913/pexels-photo-6949913.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/7550538/pexels-photo-7550538.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Michael Page Japan — salary transparency report, cultural attitudes to pay discussion
    - OECD gender wage gap data 2025 — Japan 22%, France 16.1% for executives
    - OECD Pay Transparency Guidance 2023 — EU Pay Transparency Directive context
    - yaaay.jp — Salary Negotiation Basics in Japan
    - Pedersen & Partners / Forbes Japan — executive compensation Europe vs Japan comparison
    - Hofstede Insights — Japan vs France (Uncertainty Avoidance: 92 vs 86; Power Distance: 54 vs 68; Individualism: 46 vs 71)
    - EU Pay Transparency Directive — implementation timeline and requirements
    - breathehr.com — salary transparency as HR taboo
  forums:
    - ScienceDirect — "The salary taboo: privacy norms and the diffusion of information"
    - WU Executive Academy — EU Pay Transparency Directive forcing change
    - Michael Page Japan — employer salary transparency survey
    - executiveacademy.at — salary transparency and trust culture
---

# Japan Considers Your Salary a Private Matter. France Considers the Whole Topic Somewhat Vulgar. Both Will Make Negotiation Extremely Uncomfortable.

🇯🇵 **Japan** · 🇫🇷 **France**

*By Priya Mehta, The Global Office*

There is a social taboo around salary discussion that operates in most cultures, but it manifests differently enough in Japan and France that comparing them requires separate atlases. In Japan, salary is private because the cultural machinery — seniority-based pay scales, lifetime employment norms (even in their declining form), and a deeply ingrained distaste for individual claims — makes individual pay negotiation feel almost rude. In France, salary is private because the "salary taboo" sits at the intersection of class, privacy, and a cultural norm that considers discussing money too directly as a form of vulgarity. Both countries are changing — Japan's new pay transparency legislation and the EU Pay Transparency Directive both push in the direction of openness — but the pace of change is slow, and the cultural residue is thick. Hofstede's uncertainty avoidance scores (Japan 92, France 86) hint at two cultures that are deeply uncomfortable with the ambiguity that pay transparency creates, which may explain why both have avoided it so thoroughly for so long.

![Businessmen in black suits having a board meeting](https://images.pexels.com/photos/6949913/pexels-photo-6949913.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|---|---|
| Research salary ranges thoroughly before any negotiation using sources like Michael Page Japan, Robert Half, or industry salary surveys — entering a Japanese salary conversation without benchmarks is entering it blind | Ask Japanese colleagues directly what they earn — this is considered a significant social transgression, and the discomfort it creates will outlast any information you receive |
...
The practical effect on the person negotiating in either country is similar: you are negotiating in an environment where the other party would prefer not to have the conversation at all, which means the conversation must be managed with particular care. In Japan, frame salary as an alignment of expectations within a valued relationship. In France, prepare a structured, rational case and present it without drama or aggressive anchoring. In both countries, know your market rate before you begin — because neither will tell you theirs.

![Colleagues working together in office](https://images.pexels.com/photos/7550538/pexels-photo-7550538.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
