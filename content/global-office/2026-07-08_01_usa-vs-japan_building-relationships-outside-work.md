...
![USA vs Japan — Building relationships outside of work](https://res.cloudinary.com/dnpcbx89m/image/upload/c_fill,w_1200,h_630/boardroom-brief/defaults/global-office-default)
...
| ✅ Do | ❌ Don't |
|---|---|
| Join a recurring hobby group — a rec league, a gym class, a church — proximity plus repetition is the actual formula | Wait for a second invitation; if you don't organize the follow-up, there often isn't one |
| Say yes to the first casual coffee or drink invite quickly | Mistake instant warmth for instant intimacy |
| Be the one who proposes the next hangout | Take a canceled plan personally — flakiness is close to a national pastime |
| Ask genuinely about someone's weekend as an icebreaker | Bring up salary, religion, or partisan politics with new acquaintances |
| Accept that friend groups shift with every life stage (school, job, kids) | Assume a work friend automatically becomes a life friend once you both quit |
| Volunteer or join a civic group if you want depth, not just breadth | Expect anyone to explain the unwritten rules — you're expected to intuit them |

#### 🇯🇵 Japan
| ✅ Do | ❌ Don't |
|---|---|
| Show up to the nomikai, at least for the first round | Decline every work drinking invitation — you'll be quietly filed as uninterested |
| Let a senior pour your drink, and pour theirs in return | Pour your own drink first |
| Join a hobby circle (sports, music, cooking) that exists apart from your job | Expect to be invited into someone's home — most friendships live outside apartments |
| Treat year one as an apprenticeship in earning trust, not a networking sprint | Push personal questions early; it reads as intrusive, not friendly |
| Learn functional Japanese — it is the actual unlock, more than any app or meetup | Rely on the expat bubble as your entire social plan indefinitely |
| Value the "acquaintance of ten years" as a legitimate, durable relationship category | Equate someone's politeness with someone's closeness |

---

### The Long Con of American Friendliness
...
### The Slow Burn of Japanese Trust
...
![Building relationships outside of work contrast — USA and Japan](https://res.cloudinary.com/dnpcbx89m/image/upload/c_fill,w_1200,h_630/boardroom-brief/defaults/global-office-default)
*Illustration: The Alignment Times*
