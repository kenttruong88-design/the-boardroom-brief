...
images:
  ...
  body: https://images.pexels.com/photos/5765/table-coffee-cup-book.jpg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Brazil Ministry of Agriculture — 90% of households consume rice and beans daily
    - Brazil obesity data — 28.2% adult women, 21.1% adult men (2024)
    - PubMed — ultra-processed food consumption and obesity in Brazil
    - PMC — Brazilian meal patterns; lunch outside home linked to higher BMI
    - TheBrazilBusiness.com — dining culture in Brazil
    - Sweden Coffee in Wikipedia — Sweden ranks among world's top 3 coffee consumers per capita
    - WorldAtlas — Top coffee-consuming countries (Sweden ~8.2 kg/person/year)
    - MTPak — fika culture and coffee drinking statistics
    - Springer Nature — "Fika in the Anthropocene" — sustainability of Swedish food rituals (2025)
    - Nordic Nutrition Recommendations 2023 — Swedish dietary patterns
    - Hofstede Insights — Brazil (IDV: 38, UAI: 76) vs Sweden (IDV: 71, UAI: 29)
  forums:
    - r/brazil — discussions on rice/beans daily habits, churrasco culture, food as social bonding
    - r/sweden — fika culture debates; plant-based alternatives; meal timing discussions
    - r/expats — comparing food cultures when moving between countries
