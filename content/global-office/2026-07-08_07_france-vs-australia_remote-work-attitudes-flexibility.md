...
sources:
  official:
    - "OECD — Telework and Productivity (oecd.org)"
    - "INSEE / The Local France — teleworking frequency data, 2024"
    - "Australian Bureau of Statistics — Working Arrangements, August 2025"
    - "Fair Work Ombudsman (Australia) — Right to Disconnect"
    - "Mayer Brown — France and Australia: The Right to Disconnect Q&A, 2025"
    - "Deloitte Global — 2025 Human Capital Trends"
    - "Hofstede Insights / The Culture Factor — Country Comparison Tool"
  forums:
    - "r/france (Reddit)"
    - "Quora — remote work visa constraints in France"
    - "Blind (teamblind.com) — Atlassian remote work culture thread"
...
![France vs Australia — Remote work attitudes and flexibility policies](https://res.cloudinary.com/dnpcbx89m/image/upload/c_fill,w_1200,h_630/boardroom-brief/defaults/global-office-default)
...
![Remote work contrast — France and Australia](https://res.cloudinary.com/dnpcbx89m/image/upload/c_fill,w_1200,h_630/boardroom-brief/defaults/global-office-default)
*Illustration: The Alignment Times*
