...
sources:
  official:
    - OECD Better Life Index — France (Community/social connections)
    - OECD Better Life Index — Australia (Community/social connections)
    - Hofstede Insights / The Culture Factor country comparison tool (Individualism dimension)
    - Brookings — "France's 35 Hour Work Week: Flexibility Through Regulation"
    - The Local France — expat survey on French social integration
    - InterNations Expat Insider survey
  forums:
    - Quora — "What are the biggest cultural differences when working with French colleagues?"
    - InterNations Expat Insider survey commentary (via InterNations.org / Facebook)
    - The Local France — "It can take a decade to make French friends"
...
![France vs Australia — Bonding culture](https://res.cloudinary.com/dnpcbx89m/image/upload/c_fill,w_1200,h_630/boardroom-brief/defaults/global-office-default)
...
| ✅ Do | ❌ Don't |
|---|---|
| Accept the first apéro invitation, even if you don't drink — it's a screening round, not a party | Expect an invitation to someone's actual home before month six; that's a different, later tier entirely |
| Use "vous" with colleagues until someone explicitly proposes "tu" | Over-share personal details in the break room — the wall between professional and private life is load-bearing |
| Show up, at least briefly, to the pot (office leaving party) | Skip lunch to eat at your desk — it reads as antisocial, not diligent |
| Learn a few defensible opinions on food, politics, or film | Mistake reserve for rejection — French friendships form slowly but tend to hold |
| Let colleagues set the pace of familiarity | Push for fast intimacy; it reads as presumptuous rather than friendly |
| Treat the two-hour lunch as a genuine bonding ritual, not a delay | Assume the 35-hour week means fewer office friendships — it mostly just means less forced overtime bonding |

#### 🇦🇺 Australia
| ✅ Do | ❌ Don't |
|---|---|
| Say yes to Friday drinks or the office BBQ in your first two weeks | Decline repeatedly — it reads as standoffish, not busy |
| Bring something to the barbecue — a drink, a salad, anything | Assume a gift is expected; mateship runs on reciprocity, not generosity |
| Take gentle teasing as a sign you've been accepted | Take "taking the mickey" personally — it's often the warmest thing that happens to you all week |
| Join a sports club, gym group, or hobby circle outside work | Expect the office alone to produce a real social life |
| Use first names with your boss from day one | Read first-name informality as evidence of a deep friendship — that takes longer |
| Be patient about home invitations | Assume instant friendliness means you've cracked the established, often school-era, friend group |
...
![Bonding culture contrast — France and Australia](https://res.cloudinary.com/dnpcbx89m/image/upload/c_fill,w_1200,h_630/boardroom-brief/defaults/global-office-default)
*Illustration: The Alignment Times*
