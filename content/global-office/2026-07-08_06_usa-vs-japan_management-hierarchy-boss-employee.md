...
![USA vs Japan — Management hierarchy and boss-employee relationships](https://res.cloudinary.com/dnpcbx89m/image/upload/c_fill,w_1200,h_630/boardroom-brief/defaults/global-office-default)
...
| ✅ Do | ❌ Don't |
|---|---|
| Speak up in your first team meeting, even as the newest hire | Assume "we're all equals here" means your manager can't fire you without cause |
| Ask your manager directly for the promotion criteria in writing | Wait for your boss to notice your work and reward it unprompted |
| Treat your one-on-one as a real forum for pushback and negotiation | Mistake informality (first names, jeans, open-door policy) for an absence of hierarchy |
| Document your accomplishments — self-advocacy is expected, not vain | Assume a friendly manager is a permanent one; reorgs happen fast |
| Ask "who actually owns this decision" before assuming consensus is required | Confuse being invited to a meeting with being invited to overrule it |

#### 🇯🇵 Japan
| ✅ Do | ❌ Don't |
|---|---|
| Learn *nemawashi* — build agreement one-on-one before the group meeting | Raise a disagreement with your boss's plan in front of the whole team |
| Let seniority visibly shape seating, speaking order, and who pours drinks | Expect a promotion timeline to track your output rather than your tenure |
| Stay until your section chief signals it's acceptable to leave | Leave the moment your contracted hours end, especially in your first year |
| Route new ideas through your immediate senior, not straight to the top | Skip a level to pitch your boss's boss directly, however good the idea |
| Treat a vague "it's a bit difficult" from your boss as a firm no | Push for a direct yes/no answer when ambiguity has already given you one |
