...
author: Priya Mehta
countries: Netherlands, India
subject: Work-life balance and overtime norms
word_count: 1040
images:
  hero: https://images.pexels.com/photos/18848934/pexels-photo-18848934.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/5537935/pexels-photo-5537935.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - OECD Working Hours Data 2024 — Netherlands 1445 hours per year
    - Dutch Central Bureau of Statistics — average 27.7 hours per week 2023
    - OECD — Part-Time and Partly Equal Gender and Work in the Netherlands 2019
    - CII-MediBuddy Report 2024 — India burnout rate 62%
    - Solsaga / PeopleMatters — India IT sector 70+ hour workweek statistics
    - WHO — working hours health impacts
  forums:
    - r/india
    - r/Netherlands
    - r/cscareerquestions
...
In 2023, the co-founder of Infosys made international headlines calling on young Indians to work 70 hours a week. The following year, he revised that figure upward to 72 and cited China's now-illegal 996 schedule as an aspirational model. That same year, the average Dutch worker clocked 27.7 hours per week — the lowest in the European Union — and the Netherlands ranked fifth globally for work-life balance. These numbers do not represent two ends of the same spectrum. They represent two entirely different theories of what work is for.

![Woman working remotely on a laptop outdoors in an urban park, symbolising flexible work culture](https://images.pexels.com/photos/18848934/pexels-photo-18848934.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|---|---|
| Leave at your contracted time — it signals good time management | Stay late to look dedicated — it signals poor planning |
| Negotiate part-time hours without guilt, even in senior roles | Expect colleagues to answer messages after 6pm |
| Bring a direct, agenda-driven approach to meetings | Confuse silence with approval — the Dutch will tell you if something is wrong |
| Protect weekends and personal time as non-negotiable | Measure performance by hours worked; output is what counts |
| Discuss salary and conditions frankly during hiring | Over-explain why you want work-life balance — it's assumed |
| Take your 25+ vacation days fully — all of them | Work through illness; Dutch sick leave norms are robust and expected |

#### 🇮🇳 India
| ✅ Do | ❌ Don't |
|---|---|
| Build relationships and trust before pushing back on hours | Assume your contract hours reflect actual expectations |
| Clarify which late-night meetings are genuinely optional | Log off without informal signal to seniors that work is done |
| Understand that burnout language is entering mainstream conversation | Mistake hustle rhetoric for universal consensus — resistance is growing |
| Use HR policies on leave and wellness where they exist | Accept 70-hour narratives as evidence-based; they are ideological |
| Find organisations where culture matches policy on paper | Confuse long hours with prestige in roles where output is measurable |
| Advocate for boundaries — younger Indian professionals increasingly do | Assume overwork culture is uniform — sector and company vary enormously |

---

## Netherlands

The Dutch approach to working hours is, by global standards, an anomaly significant enough to have generated its own academic literature. Workers between the ages of 20 and 64 averaged 32.1 hours per week in 2024 — the shortest in the entire EU — while the broader population average came in at 27.7 hours (Statistics Netherlands, 2023). The OECD places Dutch annual working hours at approximately 1,445, against an OECD average of around 1,736. This is not a country of chronic absenteeism or low productivity. Measured by GDP per hour worked, the Netherlands consistently ranks in the global top tier at approximately USD 97 — well above the OECD average.

What makes the Netherlands genuinely unusual is the normalisation of part-time work across genders and career levels. Approximately half of all Dutch workers are employed part-time — not as a mark of underemployment, but as a deliberate lifestyle arrangement supported by robust employment protections. Over 50% of Dutch women work part-time, and so do roughly 25% of Dutch men (OECD, 2019). In most countries, part-time employment is associated with poor pay, limited benefits, and stunted career progression. In the Netherlands, it frequently comes with all three things intact. The 2021 InterNations Expat Insider survey found 78% of expats in the Netherlands rated their work-life balance favourably — and 37% named it as what they loved most about working there.
...
Narayana Murthy's 70-hour proposal landed in October 2023 and was not, as some international coverage implied, the eccentric view of one elderly billionaire. It reflected a strand of thinking that is genuinely present in Indian corporate culture, particularly in the IT sector, where the notion of grinding through long hours as a form of patriotic contribution — the nation is developing, therefore you must work harder — has deep roots and considerable institutional backing. He subsequently escalated to 72 hours, citing China's 996 schedule as a reference point without mentioning that Chinese courts had ruled it illegal, that software developers had protested it publicly, or that a counter-movement called "lying flat" had been prominent enough to attract official criticism.

The data suggests this ethic is not merely rhetorical. A survey of Indian IT professionals found that 72% regularly exceed the legal 48-hour maximum workweek, with 25% working more than 70 hours per week — figures that align more closely with China's infamous 996 schedule than with anything in Western Europe (Solsaga, 2024). A 2024 CII-MediBuddy report found that 62% of Indian employees experience burnout, against a global average of just 20%. Among IT professionals specifically, 83% report burnout symptoms and 68% show at least two clinical indicators. McKinsey estimated the economic cost of poor mental health — much of it connected to overwork — at USD 14 billion annually. The irony of working 70 hours a week to build national prosperity while generating a $14 billion drag on that same prosperity has not gone entirely unnoticed.

The debate inside India is more nuanced than international coverage suggested. Murthy's comments generated genuine pushback — including from politicians who argued for a four-day week. Younger Indian workers, particularly those with international exposure, increasingly resist unlimited-hour expectations. Glassdoor reviews of major Indian IT companies consistently flag work-life balance as a primary point of dissatisfaction. The culture of overwork is real; so is the growing resistance to it.

## The Reckoning

The comparison between the Netherlands and India is, at one level, a comparison between two theories of how economies develop. The Dutch model argues: extract maximum value per hour, protect workers from exhaustion, and trust that sustainable productivity over decades outperforms unsustainable intensity over years. The Indian model — or at least the Murthy version — argues: the country is behind, the window is open, and the way to close the gap is to work harder than anyone else, now, while you still can.

The problem with the second argument is the data. The Netherlands produces approximately USD 97 of GDP per hour worked. India produces considerably less per hour — and asks workers to contribute far more of them. Long hours do not automatically compound into output, a fact well understood in organisational psychology and apparently not yet incorporated into co-founder keynote addresses.

![Two colleagues collaborating on work outdoors, representing diverse and flexible working arrangements](https://images.pexels.com/photos/5537935/pexels-photo-5537935.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
What expats moving between the two environments consistently report is not that one culture is lazy and the other industrious. They report that the assumptions embedded in each system — about what dedication looks like, what a career is supposed to cost you, and what you are allowed to want from a working day — are so different that the adjustment feels less like changing jobs and more like changing species. As one Dutch expat in Mumbai put it, with characteristic directness: "I'm not less committed than my colleagues here. I'm committed to different things." In the Netherlands, that sentence would end a meeting. In Bangalore, it might start one.
