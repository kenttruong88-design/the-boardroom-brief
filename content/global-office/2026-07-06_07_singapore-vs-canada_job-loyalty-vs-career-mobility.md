...
substitution_note: "Original assignment (Performance reviews and feedback culture) already covered for this pair on 2026-07-02; substituted with an unused subject."
word_count: 1170
images:
...
sources:
  official: [Statistics Canada tenure data, Singapore Ministry of Manpower labour turnover statistics, MyCareersFuture (Workforce Singapore), Ethos BC Singapore recruitment commentary, LinkedIn Workforce Insights, Hofstede Insights]
  forums: [r/askSingapore, r/PersonalFinanceCanada, Quora, Internations Singapore, Blind]
---

# The Two-Year Itch vs the Eight-Year Settle: Job Loyalty in Singapore and Canada

**🇸🇬 Singapore · 🇨🇦 Canada**

***By Priya Mehta, The Global Office***

Average employee tenure in Canada was 8.5 years in 2023, per Statistics Canada — a figure that would strike the median Singaporean professional as a rounding error, or possibly a hostage situation. In Singapore's tight, expensive, perpetually benchmarked labour market, the two-to-three-year hop is a recognised career instrument, openly discussed and priced into salary expectations. In Canada, loyalty is not so much demanded as ambient: people settle into employers the way they settle into parkas, for reasons of comfort, benefits and the sheer administrative effort of change. Both markets will judge your CV — just against opposite templates.
...
| ✅ Do | ❌ Don't |
|---|---|
| Benchmark your salary annually; the market moves and staying still is a pay cut | Don't hop more than once under 18 months — even Singapore has a limit, and hiring managers track patterns |
| Use offers as leverage; counteroffers are common and expected | Don't assume loyalty earns protection — retrenchments come swiftly when quarters go bad |
...
| Mind your Employment Pass or PR situation — job changes interact with immigration status | Don't burn bridges; Singapore's professional circles are one degree of separation wide |
...
| Learn internal mobility — big Canadian employers prefer promoting sideways-and-up internally | Don't assume a two-year stint reads as ambition; some managers still read it as risk |
| Negotiate at hire; annual raises are modest (2–4%) and inertia is priced in | Don't wait for your employer to benchmark you against the market — they are counting on you not to |
| Consider public-sector and bank roles for defined-benefit pensions — rare gold | Don't underestimate severance norms: common law "reasonable notice" grows with tenure, making long service literally valuable |
| Give proper notice and exit gracefully; the market is small and polite | Don't confuse politeness with satisfaction — Canadians quit quietly, having decided months earlier |

---

## Singapore: mobility as a market instrument

Singapore's Ministry of Manpower publishes monthly resignation rates the way other countries publish weather, and the professional culture treats movement as hygiene. Recruiters at firms like Ethos BC note that candidates now move between roles far faster than the old few-years-per-employer norm, with legal and tech seeing the highest churn; the government's own MyCareersFuture portal runs advice columns on coping with job-hopping as a settled fact. The logic is structural: a small, open economy of regional HQs means dense opportunity within one MRT ride; salary progression through internal raises consistently lags what an external move commands; and the annual bonus system — the AWS "13th month" plus variable bonuses — creates a synchronised national transfer window each spring, when payouts land and notice letters follow.

Loyalty, where it exists, is contractual rather than sentimental — and employees know the affection is mutual. Singapore employers retrench decisively in downturns, notice periods are short, and there is no expectation of the long mutual courtship found in Japan next door. Hofstede's Singapore profile — long-term orientation of 72 paired with that famously low uncertainty avoidance of 8 — describes people planning decades ahead while being entirely relaxed about changing vehicles along the way.

## Canada: loyalty as compound interest

Canada's 8.5-year average tenure is not a cultural accident; it is a well-engineered incentive structure. Benefits compound with service: vacation entitlements step up with seniority, employer pension and RRSP matching vests over years, and — a detail newcomers consistently miss — Canadian common law entitles dismissed employees to "reasonable notice" or severance that grows with tenure, meaning a decade of service is quite literally an insurance policy. Defined-benefit pensions survive in government, education and the big banks, anchoring a whole professional class in place. Statistics Canada's numbers have drifted down only slightly from the 8.9 years recorded in 2020.

The culture matches the incentives. Job-hopping tolerance is rising in tech and startups, but traditional sectors — and Canada's economy is proportionally heavy on banks, insurers, utilities and the public sector — still read frequent moves as flight risk. Canadians also change jobs politely and rarely under open conflict: the quiet, months-premeditated resignation is a national art form. The cost of all this comfort is well documented: internal raises of 2–4 per cent against external-move premiums that can run double digits, a gap Canadians tend to discover only when they finally move.

## The Reckoning

The two systems price loyalty in opposite directions. In Singapore, staying is expensive: the market reprices your skills annually and your employer, by default, does not. In Canada, leaving is expensive: you forfeit vesting, seniority vacation, severance accrual and possibly a defined-benefit pension for a raise that must clear all of that plus moving friction. A Singaporean in Toronto who hops on schedule discovers she keeps paying exit costs the local system was designed to make painful. A Canadian in Singapore who settles in for the long haul discovers, at year five, that his loyal salary is 20 per cent under market and nobody — including his own boss — respects him more for it.
...
Read the incentives before you import your habits. In Singapore, manage your career like a portfolio: benchmark yearly, move when the market says move, and treat the bonus calendar as your fiscal year. In Canada, before hopping, count everything that vests — pension matching, seniority vacation, severance accrual — because the system pays loyalty in instruments that don't show up in a salary comparison. The mobile professional thrives in both places, but only by using each country's own arithmetic.

What I'd tell a friend over a drink: in Singapore, loyalty is a discount you give your employer; in Canada, it's a bond that matures — just make sure you're holding it on purpose.
