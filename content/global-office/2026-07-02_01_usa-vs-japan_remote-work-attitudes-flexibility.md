...
sources:
  official:
    ...
    - Gallup Workplace Report 2024–2025 — hybrid work stabilization
    - Japan Work Style Reform Act — MHLW
    - Japan Dev — The State of Remote Work in Japan (2024)
    - WEF — Navigating work transformation in Japan (2025)
    - Nippon.com — Back to the Office: 70%+ of Japanese companies no longer implementing remote work
    - Hofstede Insights — USA vs Japan cultural dimension scores
  forums:
    - japan-dev.com — remote work company profiles and expat accounts
    - quora.com — remote software engineers considering Japan moves
    - joyn.tokyo — foreigner guide to remote work in Japan
    - oncereadme.com — Japan vs US work-life balance comparison
---

# The Office Is Back (Depending on Which Office)
## A Field Guide to Remote Work in the USA and Japan
...
![USA vs Japan — Remote work attitudes and flexibility policies](https://images.pexels.com/photos/4050302/pexels-photo-4050302.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
...
Japan's remote work story is a study in structural friction. At the height of the pandemic, remote work adoption in Japan climbed from roughly 10% to about 20% — compared to a jump from 17% to 44% in the United States. By 2024, with pandemic pressures receding, over 70% of Japanese companies had returned to full-time office operations, according to Nippon.com. Many others simply never left.
...
![Remote work contrast — USA and Japan](https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Illustration: The Alignment Times / The Global Office*
...
> <small>*japan-dev.com — A software engineer who relocated from San Francisco to Tokyo for a Japanese tech firm noted that remote work was listed in the job offer but rarely practised by local colleagues. The unspoken expectation was that foreign hires might work from home, but Japanese teammates would be in the office, and the informal bonding that happened in the building each afternoon was quietly important to advancement — a dynamic no onboarding document mentioned.*</small>

> <small>*Quora — A developer who considered moving to Japan to work remotely for an overseas employer found that the critical variable was not Japanese company culture at all, but visa type. Japan's standard work visa restricts employment to a single listed employer, making remote work for a foreign company while living in Japan a legal grey area that the digital nomad visa, launched in March 2024, only partially resolves — and only for stays under six months.*</small>

> <small>*joyn.tokyo — An expat working at an international subsidiary in Osaka described the hanko system as the hidden enemy of remote work: her team had been nominally hybrid for two years, but approval workflows still required physical stamps on certain documents, which meant someone always had to be in the office on payment days — a rotation that no one had officially planned, and that fell, predictably, to the most junior person.*</small>

> <small>*oncereadme.com — A Japanese professional who spent three years at a US company before returning to a Japanese firm described the adjustment in reverse: American managers assumed you would manage your own time and communicate proactively about blockers. Back in Japan, absence of communication was interpreted not as autonomy but as disengagement — a complete inversion that took months to recalibrate.*</small>
