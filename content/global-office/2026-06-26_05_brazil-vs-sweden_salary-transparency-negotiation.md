...
word_count: 1040
images:
  hero: https://images.pexels.com/photos/3184433/pexels-photo-3184433.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
  body: https://images.pexels.com/photos/7681091/pexels-photo-7681091.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop
sources:
  official:
    - Sweden EU Pay Transparency Directive draft legislation (May 2024) — new chapter 3a to Discrimination Act
    - KPMG Sweden — Pay Transparency Directive analysis 2025
    - Sweden gender pay gap — unadjusted 16%, adjusted 3.4% (OECD 2024)
    - Ravio.com — Pay transparency Sweden employer guide
    - Brazil Equal Pay Enforcement — Law 14.611/2023; enforcement began 2024
    - Brazil gender pay gap — women earn 78.8 cents per male dollar; managers 73.4% (2025)
    - TheBrazilBusiness.com — salary negotiation in Brazil guide
    - Hofstede Insights — Sweden (IDV: 71, UAI: 29, PDI: 31) vs Brazil (IDV: 38, UAI: 76, PDI: 69)
    - WageIndicator — Sweden union salary strategy 2026
    - ETUI — collective bargaining Sweden 2025
  forums:
    - r/sweden — threads on lönesamtal (salary review) experiences and norms
    - r/brazil — salary negotiation experiences; pay taboo discussions
    - r/AskEurope — Swedish salary transparency culture anecdotes
    - CE Sweden — unwritten rules of Swedish salary negotiation (löneförhandling)
---
...
![Brazil vs Sweden — Salary transparency and negotiation culture](https://images.pexels.com/photos/3184433/pexels-photo-3184433.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
...
| ✅ Do | ❌ Don't |
|---|---|
| Research your *piso salarial* (professional category floor) before any negotiation | Ask a colleague what they earn — this is considered deeply inappropriate |
| Build the relationship first; trust precedes the salary conversation in most Brazilian workplaces | Lead with your personal financial needs as justification for a raise |
| Use indirect signals and timing strategically — the *jeitinho* approach applies here | Expect full salary transparency from a hiring manager before you receive an offer |
| Negotiate more assertively at smaller companies, where HR structures are less rigid | Assume your written contract covers all relevant compensation — benefits packages matter enormously |
| Invoke your value to the team and your seniority in the relationship | Push for a direct number in a first meeting; patience is culturally expected |
| Know that benefits (meal vouchers, transport, health insurance) are often more negotiable than base salary | Conflate the national minimum wage with what the market actually pays in your sector |

#### 🇸🇪 Sweden
| ✅ Do | ❌ Don't |
|---|---|
| Arrive at your *lönesamtal* (annual review) with documented performance data and market benchmarks | Advocate based on personal financial needs — this carries no weight culturally |
| Join the relevant union; sector-wide *kollektivavtal* set the floor and anchor expectations | Expect raises of more than 3% in a single year; the structure caps individual gains |
| Frame your ask in terms of objective contribution and market data, not assertive self-promotion | Come in emotionally charged or use aggressive negotiating tactics — *lagom* is the register |
| Check lönstatistik.se to benchmark your role by county, age, and experience before the conversation | Stay silent if you believe you are underpaid; silence is not modesty, it just costs you money |
| Understand that job-hopping is often the only route to a significant pay increase | Expect the hiring process to be a negotiation in the traditional sense — ranges are disclosed, not debated |
| Ask HR for colleague pay data — you have a legal right to it under incoming EU directive rules | Assume the collective framework protects everyone equally; high performers often feel constrained by it |
...
![Salary transparency contrast — Brazil and Sweden](https://images.pexels.com/photos/7681091/pexels-photo-7681091.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop)
*Photo: Pexels*
