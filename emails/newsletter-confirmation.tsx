        ...
        <Container style={{ maxWidth: "600px", margin: "0 auto", backgroundColor: CREAM }}>
          ...
          <Section style={{ padding: "40px 32px" }}>
            ...
            <Text style={{ color: "#333", fontSize: "15px", fontFamily: "Georgia, serif", lineHeight: "1.7", margin: "0 0 16px" }}>
              {greeting} The Boardroom Brief delivers daily financial news with a dry corporate culture twist — real markets, real news, questionable corporate poetry.
            </Text>
          ...
          <Section style={{ padding: "20px 24px", backgroundColor: "#e8e2d8", borderTop: `1px solid ${BORDER}` }}>
            <Text style={{ color: MUTED, fontSize: "11px", fontFamily: "Arial, sans-serif", textAlign: "center", margin: "0 0 8px" }}>
              <Link href="https://theboardroombrief.com" style={{ color: MUTED, textDecoration: "underline" }}>The Boardroom Brief</Link>
              {"  ·  "}
              <Link href="https://theboardroombrief.com/unsubscribe" style={{ color: MUTED, textDecoration: "underline" }}>Unsubscribe</Link>
              {"  ·  "}
              <Link href="https://theboardroombrief.com/privacy" style={{ color: MUTED, textDecoration: "underline" }}>Privacy</Link>
            </Text>
